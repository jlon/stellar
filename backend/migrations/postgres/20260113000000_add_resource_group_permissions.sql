...
('menu:cluster-ops:resource-groups', '资源组管理', 'menu', 'cluster-ops:resource-groups', 'view', '查看资源组管理') ON CONFLICT DO NOTHING;
...
('api:resource-groups:analysis', '资源使用分析', 'api', 'resource-groups', 'analysis', 'GET /api/clusters/resource-groups/analysis') ON CONFLICT DO NOTHING;
...
WHERE p.code = 'menu:cluster-ops:resource-groups' ON CONFLICT DO NOTHING;
