...
('menu:agent', '智能运维助手', 'menu', 'agent', 'view', 'AI 运维助手入口') ON CONFLICT DO NOTHING;
...
('api:agent:sessions:delete', '删除会话', 'api', 'agent', 'sessions:delete', 'DELETE /api/agent/sessions/:id') ON CONFLICT DO NOTHING;
...
WHERE code IN ('menu:agent', 'api:agent:chat', 'api:agent:sessions:list', 'api:agent:sessions:get', 'api:agent:sessions:delete') ON CONFLICT DO NOTHING;
