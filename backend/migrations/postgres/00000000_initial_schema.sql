-- ============================================================================
-- Stellar 平台元数据 DDL —— PostgreSQL（单文件）
--
...
CREATE TABLE IF NOT EXISTS metrics_snapshots (
    ...
    qps DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    rps DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    query_latency_p50 DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    query_latency_p95 DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    query_latency_p99 DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    ...
    total_cpu_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    avg_cpu_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    total_memory_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    avg_memory_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    disk_total_bytes BIGINT NOT NULL DEFAULT 0,
    disk_used_bytes BIGINT NOT NULL DEFAULT 0,
    disk_usage_pct DOUBLE PRECISION NOT NULL DEFAULT 0.0,

    -- Storage Metrics
    tablet_count BIGINT NOT NULL DEFAULT 0,
    max_compaction_score DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    ...
    jvm_heap_usage_pct DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    ...
    network_send_rate DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    network_receive_rate DOUBLE PRECISION NOT NULL DEFAULT 0.0,

    -- IO Metrics (BE)
    io_read_bytes_total BIGINT NOT NULL DEFAULT 0,
    io_write_bytes_total BIGINT NOT NULL DEFAULT 0,
    io_read_rate DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    io_write_rate DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    ...
    safe_mode BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS daily_snapshots (
    ...
    avg_qps DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    max_qps DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    min_qps DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    avg_latency_p99 DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    max_latency_p99 DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    ...
    avg_cpu_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    max_cpu_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    avg_memory_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    max_memory_usage DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    avg_disk_usage_pct DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    max_disk_usage_pct DOUBLE PRECISION NOT NULL DEFAULT 0.0,

    -- Availability Statistics
    avg_backend_alive DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    min_backend_alive BIGINT NOT NULL DEFAULT 0,
    total_downtime_seconds BIGINT NOT NULL DEFAULT 0,
    availability_pct DOUBLE PRECISION NOT NULL DEFAULT 100.0,
    ...
    data_growth_rate DOUBLE PRECISION NOT NULL DEFAULT 0.0,
...
CREATE TABLE IF NOT EXISTS permission_requests (
    ...
    valid_until TIMESTAMPTZ,              -- Expiration time for temporary permissions
...
CREATE OR REPLACE FUNCTION touch_llm_providers_updated_at()
RETURNS TRIGGER AS $$
BEGIN
...
FOR EACH ROW EXECUTE FUNCTION touch_llm_providers_updated_at();
...
('admin', '管理员', '拥有所有权限', TRUE, NULL),
('super_admin', '超级管理员', '拥有所有权限(跨组织)', TRUE, NULL) ON CONFLICT DO NOTHING;

-- ==============================================
-- 7.3 Insert Default Organization
-- ==============================================
INSERT INTO organizations (code, name, description, is_system)
VALUES ('default_org', 'Default Organization', 'System default organization (built-in)', TRUE) ON CONFLICT DO NOTHING;

-- ==============================================
-- 7.4 Insert Default System Functions
-- ==============================================
INSERT INTO system_functions (cluster_id, category_name, function_name, description, sql_query, display_order, category_order, is_favorited, is_system, created_by, created_at, updated_at) VALUES
-- Database Management
...
-- System Maintenance
(NULL, '系统维护', 'meta_recovery', '元数据恢复', 'HTTP_QUERY', 0, 8, false, true, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) ON CONFLICT DO NOTHING;
...
('api:db-auth:preview-sql', '预览SQL', 'api', 'db-auth', 'preview-sql', 'POST /api/db-auth/preview-sql') ON CONFLICT DO NOTHING;

-- ==============================================
-- 7.6 Insert Default LLM Provider
-- ==============================================
INSERT INTO llm_providers (name, display_name, api_base, model_name, is_active, enabled, priority)
VALUES ('deepseek', 'DeepSeek Chat', 'https://api.deepseek.com/v1', 'deepseek-chat', FALSE, TRUE, 1) ON CONFLICT DO NOTHING;
...
SELECT (SELECT id FROM roles WHERE code='admin'), id FROM permissions ON CONFLICT DO NOTHING;

-- ==============================================
-- 9.2 Assign All Permissions to Super Admin Role
-- ==============================================
INSERT INTO role_permissions (role_id, permission_id)
SELECT (SELECT id FROM roles WHERE code='super_admin'), id FROM permissions ON CONFLICT DO NOTHING;
...
WHERE p.code IN ('menu:system:users', 'menu:system:roles', 'menu:system:organizations', 'menu:system:llm') ON CONFLICT DO NOTHING;
...
FROM role_permissions rp
JOIN permissions p ON rp.permission_id = p.id
WHERE p.code IN ('menu:nodes:frontends', 'menu:nodes:backends') ON CONFLICT DO NOTHING;
...
FROM role_permissions rp
JOIN permissions p ON rp.permission_id = p.id
WHERE p.code IN ('menu:queries:execution', 'menu:queries:profiles', 'menu:queries:audit-logs', 'menu:queries:blacklist') ON CONFLICT DO NOTHING;
...
-- ==============================================
INSERT INTO permissions (code, name, type, resource, action, description) VALUES
('api:clusters:queries:execution:history', '查询执行历史', 'api', 'clusters', 'queries:execution:history', 'GET/DELETE /api/clusters/queries/execution-history') ON CONFLICT DO NOTHING;
...
INSERT INTO role_permissions (role_id, permission_id)
SELECT (SELECT id FROM roles WHERE code='admin'), id FROM permissions
WHERE code = 'api:clusters:queries:execution:history' ON CONFLICT DO NOTHING;
...
AND p.code = 'api:clusters:queries:execution:history' ON CONFLICT DO NOTHING;
...
('api:agent:chat-actions:cancel', '拒绝对话内动作', 'api', 'agent', 'chat-actions:cancel', 'POST /api/agent/chat-actions/:id/cancel') ON CONFLICT DO NOTHING;
...
INSERT INTO role_permissions (role_id, permission_id)
SELECT (SELECT id FROM roles WHERE code='admin'), id FROM permissions
WHERE code IN ('api:agent:chat-actions:confirm', 'api:agent:chat-actions:cancel') ON CONFLICT DO NOTHING;
...
INSERT INTO permissions (code, name, type, resource, action, description) VALUES
('api:agent:messages:feedback', '评价助手的回答', 'api', 'agent', 'messages:feedback', 'POST /api/agent/messages/:id/feedback') ON CONFLICT DO NOTHING;
...
INSERT INTO role_permissions (role_id, permission_id)
SELECT (SELECT id FROM roles WHERE code='admin'), id FROM permissions
WHERE code IN ('api:agent:messages:feedback') ON CONFLICT DO NOTHING;
...
INSERT INTO permissions (code, name, type, resource, action, description) VALUES
('api:agent:sessions:rename', '重命名会话', 'api', 'agent', 'sessions:rename', 'PATCH /api/agent/sessions/:id') ON CONFLICT DO NOTHING;
...
INSERT INTO role_permissions (role_id, permission_id)
SELECT (SELECT id FROM roles WHERE code='admin'), id FROM permissions
WHERE code IN ('api:agent:sessions:rename') ON CONFLICT DO NOTHING;
